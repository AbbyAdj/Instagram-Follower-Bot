...
from utils.helper import wait, NoDetailsProvided
...
class InstagramFollowerBot:
    """The bot objects are initialised with the instagram username and password.
    Note that the bot performs a login and initializes the selenium webdriver upon initialization."""
    ...
    def initialize_driver(self):
        """Initializes webdriver for the bot"""
    ...
    def login(self):
        ...
        The multiple wait functions are meant to prevent bot detection"""
        wait(3)
        ...
        wait(2)
        # TODO Check if incorrect password given.
        try:
    ...
    def navigate_to_account(self, **account_details: str):
        ...
        elif account_name in account_details.values():
            # Not yet implemented
            pass

        else:
            print("You must provide either a valid url or a valid username")
            raise NoDetailsProvided
